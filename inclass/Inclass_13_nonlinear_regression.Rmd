...
#nlsfit <- 
          # nls(function, data = hd.temp, start = list())
...
Create a dataframe called temp.age with all combinations of temperature and vehicle ages (0-100 temperature, and ages 0-12)
...
Have separate factets for each temperature range
