...
Have separate panels for each temperature Plot age on the x-axis Plot NOx emissions on the y-axis Use geom_jitter to plot the data Use geom_line and geom_ribbon to plot the predicted values
