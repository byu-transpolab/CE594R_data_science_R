...
```{r}
sort(unique(diamonds$color),decreasing=T)

diamonds <- diamonds %>%
           ## mutate(color = factor(color,levels = ### ,ordered=F))
...
Use interval from teh Lubridate tidyverse package
